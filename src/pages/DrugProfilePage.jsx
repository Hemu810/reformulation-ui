  ...
  return (
    <>
      ...
      <div className="container" style={{ paddingTop: 20 }}>
        ...
        {/* 2×2 grid — all four tiles in aligned rows */}
        <div style={{ display: "grid", gridTemplateColumns: "320px 1fr", gap: 20 }} className="fade-up delay-2">

          {/* Row 1 left: Formulation */}
          <div className="card">
          ...
          {/* Row 1 right: ANDA Filers — height matches Formulation row */}
          <div className="card" style={{ display: "flex", flexDirection: "column" }}>
            ...
            {ip.anda_filers?.length ? (
              ...
              <div className="empty-state" style={{ flex: 1, padding: "32px" }}>
          ...
          {/* Row 2 right: Market & Commercial — below ANDA, beside IP */}
          <div className="card">
        ...
        {/* Button — below all four tiles */}
        <div style={{ display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap", marginTop: 20 }} className="fade-up delay-3">
